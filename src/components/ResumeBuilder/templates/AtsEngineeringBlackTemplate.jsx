    ...
    <div className="mt-2 flex gap-2">
      {[1, 2, 3, 4, 5].map((zap) => (
        <FiZap
          key={zap}
          className={`text-[14px] ${
            zap <= safeRating ? "text-[#b8942d]" : "text-gray-300"
          }`}
        />
      ))}
    </div>
...
const SectionTitle = ({ children }) => (
  <h2 className="mb-3 border-b border-[#b8942d] pb-1 text-[22px] font-bold text-[#b8942d]">
    {children}
  </h2>
);

const SidebarTitle = ({ children }) => (
  <h2 className="mb-3 border-b border-[#b8942d] pb-1 text-[18px] font-bold text-[#b8942d]">
    {children}
  </h2>
);

const AtsEngineeringBlackTemplate = ({ resumeData }) => {
  const {
    personal = {},
    summary = "",
    experience = [],
  ...
  return (
    <section className="w-full min-h-[1123px] bg-white px-5 py-5 font-serif text-black">
      <div className="grid grid-cols-[270px_1fr] gap-5">
        ...
        <aside>
          {personal.photoUrl && (
            <img
              ...
              className="mb-4 h-64 w-full rounded-xl object-cover avoid-break"
            />
          )}
        ...
        {/* RIGHT SIDE */}
        <main>
          <header className="mb-5 rounded-lg bg-[#b8942d] px-5 py-4 text-white avoid-break">
          ...
          {(personal.linkedin || personal.website) && (
            <section className="mb-5 avoid-break">
              ...
              <div className="grid grid-cols-3 gap-5 text-[14px]">
                {personal.linkedin && (
                  <div>
...
export default AtsEngineeringBlackTemplate;
