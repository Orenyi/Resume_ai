          ...
          <div className="flex flex-col">
            ...
            <div className="mt-12 flex flex-col md:flex-row md:items-center gap-6">
              ...
              <button
                ...
                className="text-[18px] bg-transparent text-black py-3 px-6 rounded-lg border border-black hover:bg-[var(--color-secondary)] hover:text-white hover:border-none transition-colors duration-300"
              >
                Browse Templates
              </button>
            </div>
